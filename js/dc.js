...
dc.coordinateGridChart = function (_chart) {
    ...
    var _renderHorizontalGridLines = false;
    var _renderVerticalGridLines = false;
    ...
    **/
    _chart.renderVerticalGridLines = function (_) {
        if (!arguments.length) return _renderVerticalGridLines;
        _renderVerticalGridLines = _;
        return _chart;
    };
